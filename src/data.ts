import { Milestone, DragItem, QuizQuestion, CollaborativeTask } from "./types";
...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    brief: "Khẳng định nước ta đang ở chặng đường đầu tiên của thời kỳ quá độ đầy thử thách và định hình lại các mục tiêu ưu tiên trước mắt.",
    content: "Đại hội tập trung vào việc ổn định cuộc sống nhân dân, tinh giảm đầu tư công nghiệp nặng tràn lan và củng cố vững chắc thế trận quốc phòng toàn dân.",
    details: {
  ...
  },
  {
    ...
    content: "Sự đấu tranh tư tưởng quyết liệt giữa mô hình quan liêu bao cấp cũ và cơ chế hạch toán kinh doanh tự chủ mới.",
    details: {
